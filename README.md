...
- **Bash CLI Utility:** A menu-driven interface (`queries_script.sh`) allowing users to query trends, calculate averages, and compare biometric readings across multiple users without writing raw SQL.
...
- Make the script executable: `chmod +x queries_script.sh`
- Run the tool: `./queries_script.sh`
